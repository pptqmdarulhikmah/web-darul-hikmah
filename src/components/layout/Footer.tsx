...
const Footer = () => {
    return (
        <footer className="bg-background-dark text-white border-t border-white/10 pt-20 pb-10" id="kontak">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-lg font-bold font-display leading-none">Pesantren</h3>
                                <h3 className="text-accent text-base font-medium font-display leading-none">Al-Hikmah</h3>
                            </div>
                        </div>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-lg font-bold font-display text-white mb-6">Tautan Cepat</h4>
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="text-lg font-bold font-display text-white mb-6">Hubungi Kami</h4>
                        <ul className="space-y-4 text-sm text-gray-400">
                    ...
                    {/* Newsletter */}
                    <div>
                        <h4 className="text-lg font-bold font-display text-white mb-6">Buletin</h4>
                        <p className="text-sm text-gray-400 mb-4">Dapatkan info kajian dan berita terbaru.</p>
                        <form className="flex flex-col gap-3">
                            <input className="w-full bg-white/5 border border-white/10 rounded px-4 py-2 text-sm text-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent" placeholder="Alamat Email" type="email" />
